...
<html>
  <head>
    <title>Unregister from The PickUpPros</title>
  </head>
...
';
  ...
  if(!$pass){
    echo '
      <p>Are you sure you wish to leave The PickUpPros Community?</p>
    ...
    if ($pass == $passdB) {
      ...
      if (!result) {
        ...
        echo '
        <font color="#00FF00"> Unregistered from The PickUpPros. We hope you will reconsider us in the future.</font>
