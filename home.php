...
';
  ...
  echo '
    ...
    <br />
    <h3 id = "splashHeader"> </h3>
    <p id = "splashText"> </p>
    <img src = "SPLASH.jpg" id = "splashImg" style="visibility:hidden;" height = "1" width = "1">
    <h3>The PickUpPros</h3>
  ...
  ';
        ...
        if ($found>0) {
          ...
          <h3>Thanks for using <em>The PickUpPros</em>!</h3>
          ';
